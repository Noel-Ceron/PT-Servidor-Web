      ...
      //_equalizerDialog(new EqualizerDialog(this))
{
   ...
   // _equalizerDialog->setMediaPlayer(_player);
    ...
    _media = new VlcMedia("rtmp://streaming.upiita.ipn.mx/difusion.upiita/difusion", _instance);

    _player->open(_media);

    //connect(ui->actionOpenLocal, &QAction::triggered, this, &SimplePlayer::openLocal);
    //connect(ui->actionOpenUrl, &QAction::setDisabled, this, &SimplePlayer::openUrl);
